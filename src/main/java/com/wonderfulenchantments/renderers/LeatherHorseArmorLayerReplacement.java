...
public class LeatherHorseArmorLayerReplacement extends LayerRenderer< HorseEntity, HorseModel< HorseEntity > > {
	...
	public LeatherHorseArmorLayerReplacement( IEntityRenderer< HorseEntity, HorseModel< HorseEntity > > p_i50937_1_ ) {
		super( p_i50937_1_ );
	}
	...
	public void render( MatrixStack matrixStackIn, IRenderTypeBuffer bufferIn, int packedLightIn, HorseEntity entitylivingbaseIn, float limbSwing,
		...
		if( itemstack.getItem() instanceof HorseArmorItem ) {
			...
			IVertexBuilder ivertexbuilder = ItemRenderer.getBuffer( bufferIn, RenderType.getEntityCutout( horsearmoritem.getArmorTexture() ), false,
